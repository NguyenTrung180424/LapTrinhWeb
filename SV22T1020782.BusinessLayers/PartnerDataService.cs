...
using SV22T1020782.DataLayers.Interfaces;
using SV22T1020782.DataLayers.SQLServer;
...
public static class PartnerDataService
{
    ...
    /// <summary>
    /// Lấy thông tin khách hàng dựa vào Email
    /// </summary>
    public static async Task<Customer?> GetCustomerByEmailAsync(string email)
    {
        if (string.IsNullOrWhiteSpace(email)) return null;
        return await customerDB.GetByEmailAsync(email);
    }
